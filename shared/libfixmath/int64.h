...
static inline fix_int64_t int64_const(int32_t hi, uint32_t lo) { return (fix_int64_t){ hi, lo }; }
static inline fix_int64_t int64_from_int32(int32_t x) { return (fix_int64_t){ (x < 0 ? -1 : 0), x }; }
static inline   int32_t int64_hi(fix_int64_t x) { return x.hi; }
static inline  uint32_t int64_lo(fix_int64_t x) { return x.lo; }

static inline int int64_cmp_eq(fix_int64_t x, fix_int64_t y) { return ((x.hi == y.hi) && (x.lo == y.lo)); }
static inline int int64_cmp_ne(fix_int64_t x, fix_int64_t y) { return ((x.hi != y.hi) || (x.lo != y.lo)); }
static inline int int64_cmp_gt(fix_int64_t x, fix_int64_t y) { return ((x.hi > y.hi) || ((x.hi == y.hi) && (x.lo >  y.lo))); }
static inline int int64_cmp_ge(fix_int64_t x, fix_int64_t y) { return ((x.hi > y.hi) || ((x.hi == y.hi) && (x.lo >= y.lo))); }
static inline int int64_cmp_lt(fix_int64_t x, fix_int64_t y) { return ((x.hi < y.hi) || ((x.hi == y.hi) && (x.lo <  y.lo))); }
static inline int int64_cmp_le(fix_int64_t x, fix_int64_t y) { return ((x.hi < y.hi) || ((x.hi == y.hi) && (x.lo <= y.lo))); }

static inline fix_int64_t int64_add(fix_int64_t x, fix_int64_t y) {
	fix_int64_t ret;
	ret.hi = x.hi + y.hi;
	ret.lo = x.lo + y.lo;
...
static inline fix_int64_t int64_neg(fix_int64_t x) {
	fix_int64_t ret;
	ret.hi = ~x.hi;
	ret.lo = ~x.lo + 1;
	if(ret.lo == 0)
...
static inline fix_int64_t int64_sub(fix_int64_t x, fix_int64_t y) {
	return int64_add(x, int64_neg(y));
}

static inline fix_int64_t int64_shift(fix_int64_t x, int8_t y) {
	fix_int64_t ret;
	if(y > 0) {
		if(y >= 32)
			return (fix_int64_t){ 0, 0 };
...
static inline fix_int64_t int64_mul_i32_i32(int32_t x, int32_t y) {
	...
	return (fix_int64_t){ r_hi, r_lo };
}

static inline fix_int64_t int64_mul_i64_i32(fix_int64_t x, int32_t y) {
	int neg = ((x.hi ^ y) < 0);
	if(x.hi < 0)
		x = int64_neg(x);
	if(y < 0)
...
static inline fix_int64_t int64_div_i64_i32(fix_int64_t x, int32_t y) {
	int neg = ((x.hi ^ y) < 0);
	if(x.hi < 0)
		x = int64_neg(x);
	if(y < 0)
	...
	fix_int64_t ret = { (x.hi / y) , (x.lo / y) };
	x.hi = x.hi % y;
	x.lo = x.lo % y;

	fix_int64_t _y = int64_from_int32(y);
